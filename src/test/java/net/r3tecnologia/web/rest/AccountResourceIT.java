...
import net.r3tecnologia.CoreApiApp;
import net.r3tecnologia.config.Constants;
import net.r3tecnologia.domain.Authority;
import net.r3tecnologia.domain.User;
import net.r3tecnologia.repository.AuthorityRepository;
import net.r3tecnologia.repository.UserRepository;
import net.r3tecnologia.security.AuthoritiesConstants;
import net.r3tecnologia.service.UserService;
import net.r3tecnologia.service.dto.PasswordChangeDTO;
import net.r3tecnologia.service.dto.UserDTO;
import net.r3tecnologia.web.rest.vm.KeyAndPasswordVM;
import net.r3tecnologia.web.rest.vm.ManagedUserVM;
...
import static net.r3tecnologia.web.rest.AccountResourceIT.TEST_USER_LOGIN;
