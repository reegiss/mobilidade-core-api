...
import net.r3tecnologia.config.audit.AuditEventConverter;
import net.r3tecnologia.domain.PersistentAuditEvent;
import net.r3tecnologia.repository.PersistenceAuditEventRepository;
import net.r3tecnologia.security.AuthoritiesConstants;

import net.r3tecnologia.service.AuditEventService;
